"""Central, user-editable configuration for the Open-Source World Access Project.

This is the canonical configuration file. Application modules access it through
``app/config_bridge.py``. Secrets stay in environment variables named by
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Validate OSWAP configuration")
